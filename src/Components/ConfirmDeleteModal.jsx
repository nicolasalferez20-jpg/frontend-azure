...
function ConfirmDeleteModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-96 h-8/12 rounded-2xl bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        {/* Encabezado */}
        ...
        <div className="flex flex-col gap-2 items-center px-6 pt-6">
          ...
          <div className="mt-2 mb-6 w-full rounded-lg bg-slate-100 px-6 py-3">
            <p className="break-all text-center font-semibold text-slate-700">
              {nombreArchivo}
            </p>
          </div>
          {/* Botones */}
          <div className=" border-slate-200 flex justify-center gap-12 p-0.5 px-6 pb-6">
            <button
              onClick={onClose}
              disabled={isLoading}
