...
import {Search,PlusCircle,Clock,Download,FileText,History,Loader2,AlertCircle,
} from "lucide-react";
      ...
      <main className="w-full p-10 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between items-start min-h-50 hover:shadow-md transition-shadow">
            <div className="w-full">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Busca y consulta el registro detallado de historias de usuario
                por su ID único.
              </p>
            </div>
            <Link
              className="flex items-center gap-2 text-sm font-semibold text-[#0078d4] hover:text-[#0056b3] transition-colors mt-4"
              to="/historial"
            >
              <History size={18} />
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between items-start min-h-50 hover:shadow-md transition-shadow">
            ...
            <Link
              className="flex items-center gap-2 text-sm font-semibold text-emerald-600 hover:text-emerald-700 transition-colors mt-4"
              to="/generar"
            >
              <FileText size={18} />
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between items-start min-h-50 hover:shadow-md transition-shadow">
            <div className="w-full">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Accede a la lista completa de documentos generados anteriormente
                por el equipo.
              </p>
            </div>
            <Link
              className="flex items-center gap-2 text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition-colors mt-4"
              to="/historial"
            >
              <History size={18} />
              Ver registros &rarr;
          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-12 gap-2 text-slate-400">
              ...
              <p className="text-xs font-medium">
                Sincronizando últimas consultas...
              </p>
            </div>
          )}
